package com.project.wiremockTest.controller;

import com.project.wiremockTest.dto.UniversityDTO;
import com.project.wiremockTest.service.UniversityService;
...
public class UniversityController {
    ...
    @ApiResponses( value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid id supplies", content = @Content),
            @ApiResponse(responseCode = "404", description = "Universities not found for the given country", content = @Content)
    })
